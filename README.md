...
Key Objectives
Trend Analysis: Identifying the most popular genres and artists within the top 50.

Feature Correlation: Exploring how attributes like Beats Per Minute (BPM), Liveness, and Acousticness affect a song's overall popularity.
...
Correlation Heatmaps: Visualizing the relationship between valence (positivity) and danceability.
...
Bash
git clone https://github.com/Ayushi22jain/Spotify-Analysis.git
Install dependencies:

Bash
pip install pandas numpy matplotlib seaborn
Run the Notebooks:
Open either .ipynb file in Jupyter Notebook or VS Code to view the visualizations and step-by-step analysis.
